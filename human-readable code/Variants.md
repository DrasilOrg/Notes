...
be unreadable code, but still usable, but heavily reliant on external implicit
knowledge.
...
## [$V_2$: Solo/tightknit-group project](./V2.py)

## [$V_3$: Idiomatic, Practical, Rational](./V3.py)
